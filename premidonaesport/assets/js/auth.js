...
(function(){
  ...
  function showGate(){
    ...
    gate.innerHTML='<style>'
      ...
      +'.cbgb-sub{font-family:\'Anton\',\'Haettenschweiler\',\'Arial Narrow\',sans-serif;font-size:clamp(.85rem,2.5vw,1rem);color:rgba(244,241,236,.75);margin-bottom:2.25rem}'
      ...
      +'.cbgb-input::placeholder{color:rgba(244,241,236,.58);letter-spacing:.15em;font-size:.75rem}'
