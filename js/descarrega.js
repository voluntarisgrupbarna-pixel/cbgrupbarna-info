...
(function () {
  ...
  function estils() {
    ...
    s.textContent = [
      ...
      '.cbgb-dl input[type=text],.cbgb-dl input[type=email],.cbgb-dl input[type=tel]{width:100%;background:#F4F1EC;border:1px solid #e4e1dd;color:' + INK + ';padding:.65rem .8rem;font-family:Inter,sans-serif;font-size:.92rem;outline:none}',
      ...
      '.cbgb-dl .cbgb-dl-news{background:#F4F1EC;padding:12px 14px;margin:16px 0 4px}',
