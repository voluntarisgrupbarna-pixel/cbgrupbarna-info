  ...
  <div class="narrow prose">
    ...
    <div class="franges" aria-label="Altres portes del club">
      <a class="franja" href="/escoleta/" data-cta="campus-franja-escoleta">
        <span class="franja-ph"><img src="/img/escoleta.webp" srcset="/img/escoleta.webp 375w, /img/escoleta@2x.webp 750w" sizes="(max-width: 900px) 90vw, 230px" width="375" height="500" loading="lazy" decoding="async" alt="Nena de l'Escoleta del CB Grup Barna amb la pilota"></span>
      ...
      <a class="franja" href="/3x3/" data-cta="campus-franja-3x3">
        <span class="franja-ph"><img src="/img/team-action.webp" srcset="/img/team-action.webp 375w, /img/team-action@2x.webp 750w" sizes="(max-width: 900px) 90vw, 230px" width="375" height="500" loading="lazy" decoding="async" alt="Jugadores del CB Grup Barna amb l'equipació del club"></span>
  ...
  <div class="narrow prose">
    ...
    <div class="franges" aria-label="Altres portes del club">
      ...
      <a class="franja" href="/campus/" data-cta="3x3-franja-campus">
        <span class="franja-ph"><img src="/img/campus-hero.webp" srcset="/img/campus-hero.webp 1200w, /img/campus-hero@2x.webp 2048w" sizes="(max-width: 900px) 90vw, 230px" width="360" height="202" loading="lazy" decoding="async" alt="Entrenament del Campus de bàsquet del CB Grup Barna"></span>
