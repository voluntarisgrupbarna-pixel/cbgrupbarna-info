...
(function(){
  ...
  function showGate(){
    ...
    gate.innerHTML='<style>'
      ...
      +'.cbgb-ey{font-size:.5rem;letter-spacing:.4em;text-transform:uppercase;color:rgba(226,6,19,.8);margin-bottom:1.1rem}'
      ...
      +'.cbgb-input:focus{border-color:rgba(226,6,19,.8)}'
      ...
      +'.cbgb-foot{margin-top:2.5rem;font-size:.5rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(244,241,236,.42)}'
