...
FILES = [
    ...
    ("Qui hi entrena",
     ...
     "Quién entrena",
     "Los entrenadores del club y de Time Chamber. Han pasado Robert Willett y Nolan Willett (entrenadores de tecnificación NBA), Ainhoa López (jugadora profesional, selección española), Malak Shady (MVP de 3x3), Serge Ibaka (campeón NBA 2019) y Yankuba Sima (Euroliga).",
     "Who coaches",
     "The club's own coaches and Time Chamber's. Robert Willett and Nolan Willett (NBA skills trainers), Ainhoa López (professional player, Spain international), Malak Shady (3x3 MVP), Serge Ibaka (2019 NBA champion) and Yankuba Sima (EuroLeague) have all been through."),
    ("Quants n'hi ha",
