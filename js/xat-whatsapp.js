/* ============================================================
   ...
   ------------------------------------------------------------
   No hi ha cap servidor de xat: aquest botó flotant obre un
   petit panell amb la cara de l'Ana (coordinadora) i uns temes
   ràpids, i cada opció porta cap a wa.me amb el missatge ja
   escrit. Qui respon és sempre una persona, a l'app de WhatsApp
   del club — el xat és només la porta d'entrada.

   No fa cap petició de xarxa pròpia ni desa res del visitant:
   per això no necessita el consentiment de galetes per sortir.
...
(function () {
  ...
  var TEXTOS = {
    ca: {
      ...
      salutacio: 'Hola! 👋 Sóc l’Ana, coordinadora del club. En què et puc ajudar?',
      etiqueta: 'Tria un tema:',
      trucar: 'O truca al',
      temes: [
        { label: 'Informació general', text: 'Hola! Tinc una pregunta sobre el CB Grup Barna.' },
        { label: 'Escoleta i campus', text: 'Hola! M’interessa l’Escoleta o el Campus del CB Grup Barna. Podeu informar-me?' },
        { label: 'Patrocinis i empreses', text: 'Hola! Sóc una empresa interessada a col·laborar amb el CB Grup Barna.' },
        { label: 'Un altre tema', text: 'Hola! Tinc una consulta per al CB Grup Barna:' }
      ]
    },
    es: {
      ...
      salutacio: '¡Hola! 👋 Soy Ana, coordinadora del club. ¿En qué puedo ayudarte?',
      etiqueta: 'Elige un tema:',
      trucar: 'O llama al',
      temes: [
        { label: 'Información general', text: '¡Hola! Tengo una pregunta sobre el CB Grup Barna.' },
        { label: 'Escoleta y campus', text: '¡Hola! Me interesa la Escoleta o el Campus del CB Grup Barna. ¿Podéis informarme?' },
        { label: 'Patrocinios y empresas', text: '¡Hola! Soy una empresa interesada en colaborar con el CB Grup Barna.' },
        { label: 'Otro tema', text: '¡Hola! Tengo una consulta para el CB Grup Barna:' }
      ]
    },
    en: {
      ...
      salutacio: 'Hi! 👋 I’m Ana, the club coordinator. How can I help you?',
      etiqueta: 'Pick a topic:',
      trucar: 'Or call',
      temes: [
        { label: 'General information', text: 'Hi! I have a question about CB Grup Barna.' },
        { label: 'Escoleta & camps', text: 'Hi! I’m interested in the Escoleta or the Camp at CB Grup Barna. Could you tell me more?' },
        { label: 'Sponsorship & business', text: 'Hi! I’m a business interested in partnering with CB Grup Barna.' },
        { label: 'Something else', text: 'Hi! I have a question for CB Grup Barna:' }
      ]
    }
  };
  ...
  var ICONA_WA = '<svg viewBox="0 0 32 32" width="28" height="28" aria-hidden="true" focusable="false">' +
  ...
  var CSS = [
    ...
    'visibility:hidden;',
    'transition:transform .2s cubic-bezier(.22,1,.36,1),opacity .2s ease,visibility .2s ease}',
    '.cbgb-wa-open .cbgb-wa-panel{transform:scale(1) translateY(0);opacity:1;pointer-events:auto;visibility:visible}',
    ...
    'padding:11px 13px;font-size:13.5px;line-height:1.5;margin:0 0 16px}',
    '.cbgb-wa-lbl{margin:0 0 9px;font-family:\'Anton\',\'Futura\',sans-serif;font-weight:400;',
    'font-size:11.5px;letter-spacing:.16em;text-transform:uppercase;color:#6B6560}',
    '.cbgb-wa-temes{display:flex;flex-direction:column;gap:8px;margin:0 0 14px}',
    '.cbgb-wa-temes a{display:block;padding:10px 13px;border:1px solid rgba(16,16,14,.14);',
    'border-radius:10px;color:#10100E;text-decoration:none;font-size:13px;font-weight:500;',
    'transition:border-color .2s,background .2s,color .2s}',
    '.cbgb-wa-temes a:hover,.cbgb-wa-temes a:focus-visible{border-color:#E20613;background:#FFF5F5;color:#A8040E}',
  ...
  function obre() {
    ...
    var primer = panel.querySelector('a,button');
  ...
  function pinta() {
    ...
    launcher.innerHTML = '<span class="wa">' + ICONA_WA + '</span>' +
      '<span class="x" aria-hidden="true" style="color:#fff;font-size:26px;font-weight:300;line-height:1">✕</span>';
    ...
    t.temes.forEach(function (tema, i) {
      temesHtml += '<a href="' + enllacWa(tema.text) + '" target="_blank" rel="noopener" data-cta="xat-wa-' + i + '">' + tema.label + '</a>';
    });
    ...
    panel.innerHTML =
      ...
      '<div class="cbgb-wa-body">' +
        ...
        '<p class="cbgb-wa-lbl">' + t.etiqueta + '</p>' +
        '<div class="cbgb-wa-temes">' + temesHtml + '</div>' +
