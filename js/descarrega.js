...
(function () {
  ...
  function estils() {
    ...
    s.textContent = [
      ...
      '.cbgb-dl-bg{position:fixed;inset:0;z-index:2147483100;background:rgba(16,16,14,.62);backdrop-filter:blur(3px);display:flex;align-items:center;justify-content:center;padding:20px;overflow-y:auto}',
      ...
      '.cbgb-dl h2{font-family:"Anton","Haettenschweiler","Arial Narrow",sans-serif;font-weight:300;text-transform:uppercase;letter-spacing:.1em;font-size:1.15rem;line-height:1.35;margin:0 0 8px}',
      '.cbgb-dl h2 em{font-style:normal;color:' + RED + '}',
      '.cbgb-dl .cbgb-dl-eye{font-family:"Inter",-apple-system,BlinkMacSystemFont,system-ui,sans-serif;font-size:11px;letter-spacing:.3em;text-transform:uppercase;color:#6B6560;margin:0 0 14px}',
      ...
      '.cbgb-dl label.cbgb-dl-f span{display:block;font-family:"Inter",-apple-system,BlinkMacSystemFont,system-ui,sans-serif;font-size:11px;letter-spacing:.22em;text-transform:uppercase;color:#6B6560;margin-bottom:5px}',
      '.cbgb-dl input[type=text],.cbgb-dl input[type=email],.cbgb-dl input[type=tel]{width:100%;background:#FFFFFF;border:1px solid #e4e1dd;color:' + INK + ';padding:.65rem .8rem;font-family:Inter,sans-serif;font-size:.92rem;outline:none}',
      ...
      '.cbgb-dl .cbgb-dl-news{background:#FFFFFF;padding:12px 14px;margin:16px 0 4px}',
      '.cbgb-dl .cbgb-dl-news .cbgb-dl-chk{margin:0}',
      '.cbgb-dl button.go{width:100%;background:' + INK + ';border:1px solid ' + INK + ';color:#fff;padding:.85rem 1rem;font-family:"Inter",-apple-system,BlinkMacSystemFont,system-ui,sans-serif;font-size:11.5px;letter-spacing:.24em;text-transform:uppercase;cursor:pointer;margin-top:16px;transition:background .3s,border-color .3s}',
      '.cbgb-dl button.go:hover{background:' + RED + ';border-color:' + RED + '}',
      '.cbgb-dl button.go:disabled{opacity:.55;cursor:default}',
      '.cbgb-dl button.x{position:absolute;top:10px;right:12px;background:none;border:0;font-size:1.5rem;line-height:1;color:#6B6560;cursor:pointer;padding:4px 8px}',
      ...
      '.cbgb-dl .cbgb-dl-peu{font-family:"Inter",-apple-system,BlinkMacSystemFont,system-ui,sans-serif;font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:#6B6560;margin:18px 0 0;line-height:1.7;text-align:center}',
