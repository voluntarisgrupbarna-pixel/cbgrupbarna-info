...
(function(){
  ...
  function showGate(){
    ...
    gate.innerHTML='<style>'
      ...
      +'.cbgb-out{display:inline-block;margin-top:1.6rem;font-size:.72rem;color:rgba(255,255,255,.72);border-bottom:1px solid rgba(226,6,19,.6);text-decoration:none;padding-bottom:2px}'
