...
FILES = [
    ...
    ("Adreça",
     "Carrer de la Llacuna, 172 · 08018 Barcelona · barri del Clot, Districte de Sant Martí.",
     "Dirección",
     "Carrer de la Llacuna, 172 · 08018 Barcelona · barrio del Clot, Distrito de Sant Martí.",
     "Address",
     "Carrer de la Llacuna, 172 · 08018 Barcelona · Clot, Sant Martí district."),
    ("Com arribar-hi",
